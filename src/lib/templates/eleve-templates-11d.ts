...
const WORKSHOP_TEMPLATES: LuxuryTemplate[] = [
  ...
  // ── WK-02 ─────────────────────────────────────────────────────────────────
  {
    ...
    luxuryNotes: [
      ...
      'The bartender\'s narrative, the history of the drink and the technique rationale, elevates it from party to education',
    ],
    residentExperienceNotes: [
  ...
  // ── WK-03 ─────────────────────────────────────────────────────────────────
  {
    ...
    luxuryNotes: [
      ...
      'A small card with the piece reading "Made at [Building Name], [Date]" is a premium touch',
