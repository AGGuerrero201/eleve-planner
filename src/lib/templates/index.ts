...
const WELLNESS_TEMPLATES: LuxuryTemplate[] = [
  {
    ...
    luxuryNotes: ['Lightly mist the space with eucalyptus or lavender before guests arrive', 'Offer chilled cucumber water and hot herbal tea at close', 'A small take-home, a lavender sachet or wellness card, elevates recall'],
...
const WORKSHOP_TEMPLATES: LuxuryTemplate[] = [
  ...
  },
  {
    ...
    luxuryNotes: ['The 2-week return of fired pieces extends the experience', 'A card with the piece reading "Made at [Building Name], [Date]" is a premium touch', 'The tactile nature creates a meditative quality residents respond to'],
