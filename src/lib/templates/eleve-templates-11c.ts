...
const WELLNESS_TEMPLATES: LuxuryTemplate[] = [
  ...
  // ── W-01 ──────────────────────────────────────────────────────────────────
  {
    ...
    luxuryNotes: [
      ...
      'Small take-home — a single lavender sachet or wellness card — elevates recall',
...
const CULINARY_TEMPLATES: LuxuryTemplate[] = [
  ...
  // ── C-02 ──────────────────────────────────────────────────────────────────
  {
    ...
    luxuryNotes: [
      'The chef\'s narrative — sourcing story, technique rationale — is the luxury, not the food alone',
