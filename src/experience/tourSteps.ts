...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body:      'Every plan you save becomes reusable institutional knowledge — next summer\u2019s reception starts from this one instead of from zero. Saved plans also unlock inline editing and section-level AI refinement. Press Save Event at the bottom of the plan to add it to The Meridian\u2019s library.',
  ...
  },
  {
    ...
    title:     'The AI drafts. You direct.',
    body:      'Inside the event, nearly every line is editable — click any text to refine it in place. Better still, each section has a Regenerate button: keep the timeline you love and ask the AI for a fresh take on catering alone. That mix of control and speed is what makes the plan yours rather than a template. Try editing any field or regenerating a section.',
