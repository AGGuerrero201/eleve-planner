...
export function VendorFilters({ filters, onChange, totalCount }: VendorFiltersProps) {
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3 mb-7">
      ...
      <select
        ...
        className={cn(
          'px-3 py-2.5 text-[0.78rem] font-light border border-border rounded-sm bg-white',
      ...
      <button
        ...
        className={cn(
          'flex items-center gap-1.5 px-3.5 py-2.5 rounded-sm border text-[0.72rem] font-medium transition-all duration-150',
